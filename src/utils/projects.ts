...
Projects = [
  ...
  },
  {
    ...
    desc: "Stagger is a simple landing page created as a result of experimenting with Framer Motion Library",
    link: {
      github: "https://github.com/hendrialqori/stagger.co",
      demo: "https://stagger-co.netlify.app/",
    },
  },
  {
    id: Date.now() * Math.random(),
