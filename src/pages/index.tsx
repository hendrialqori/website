...
import { ByeIcon } from "@/components/icon";
  ...
  return (
    <Layout title="Home">
      <>
        ...
        />
        <header className="mt-1 md:mt-5" aria-label="up-side">
          <ByeIcon />
          <h1 className="text-[2.1rem] font-extrabold">Hendri Alqori</h1>
          <p className="font-semibold">Frontend Developer</p>
          <p className="text-gray-600 dark:text-gray-400">
            A guy from Landak, Indonesia <br /> who is creative, a fast learner
            and likes to write articles.
          </p>
        </header>

        <section className="mt-16" aria-label="recent-post-container">
          <h2 className="text-2xl font-bold my-5">Recent Post</h2>
