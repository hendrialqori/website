...
import { IndonesiaIcon } from "@/components/icon";
      ...
      <>
        ...
        <section className="dynamic-font md:leading-[1.75rem] mt-5 flex flex-col-reverse md:flex-row gap-2 text-gray-600 dark:text-gray-300">
          <section className="w-full md:w-9/12">
            ...
            <p className="mb-5">
              Hey everyone! My name is <b>Hendri Alqori</b> and i&apos;m from{" "}
              <a
                className="text-sky-600 dark:text-sky-400 underline"
                href="https://id.wikipedia.org/wiki/Kabupaten_Landak"
                target="_blank"
                rel="noreferrer"
              >
                Landak, West Borneo
            ...
            <blockquote>
              <em>
                ...
                yourself to understand the system&quot;
              </em>{" "}
              <br /> <br />- Ryan Dahl (Creator of Node JS)
            </blockquote>
            <p>
              Previously, I am Coffee Barista and Assistant Manager at coffee
              shop in my area as long as 2 year, middle 2021 I decided to quit
              on my job and focus on web development field. I start learning Web
              development in September 2018 when i got scholarship from{" "}
              <a
                href="https://ybmpln.org/"
            ...
            <br />
            <p>
              I am quite proficient in several technologies to build an
              interactive web app, such as React JS, Next JS, Vue JS, Express JS
              and Postgre SQL as Relational Database. But now i&apos;m focusing
              on <b>Frontend Development</b> and open to to work on this field.
            </p>
          </section>
          <aside>
        ...
        <section
          className="dynamic-font text-gray-600 dark:text-gray-300"
          aria-label="bottom-side"
        >
          <h1 className="text-xl font-bold">Better Together</h1>
          <p>
            If you want to make friendship or cooperation, please contact me on
            my social media accounts below.
          </p>
          <section
            className="flex flex-wrap gap-2 mt-3"
            aria-label="contact-wrapper"
          >
